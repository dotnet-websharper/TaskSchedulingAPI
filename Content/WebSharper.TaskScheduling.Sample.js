...
function Main(){
  ...
  const b=(t.h.push(EventQ2(t.k, "runtasks", () => t.i, () => {
    const _3=null;
    StartImmediate(Delay(() => Bind(AsAsync(runScheduledTasks()), () => Return(null))), null);
  })),t);
...
function runScheduledTasks(){
  ...
  return new Promise((_2) => {
    let r;
    const scheduler_1=globalThis.scheduler;
    let _3=scheduler_1==null?(console.error("\u274c Prioritized Task Scheduling API is not supported in this browser."),Promise.resolve(null)):scheduler_1.postTask(() => console.log("\ud83d\udd25 High Priority Task: user-blocking"), (r={},r.priority="user-blocking",r)).then(() => {
      let r_1;
      return scheduler_1.postTask(() => console.log("\u26a1 Medium Priority Task: user-visible"), (r_1={},r_1.priority="user-visible",r_1)).then(() => {
        let r_2;
        return scheduler_1.postTask(() => console.log("\ud83d\udca4 Low Priority Task: background"), (r_2={},r_2.priority="background",r_2)).then(() => {
